...
from py.ashop.FishSampling import FishSampling
from py.ashop.OperationSelection import OperationSelection
from py.ashop.Settings import Settings
# from py.ashop.SpeciesSelection import SpeciesSelection

import py.ashop.ashop_qrc
...
class Backdeck:
    ...
    def __init__(self):
        ...
        self.operation_selection = OperationSelection(app=self, db=db)
        ...
        self.context.setContextProperty("operationSelection", self.operation_selection)
        ...
        self.engine.load(QUrl('qrc:/qml/ashop/main_ashop.qml'))
...
if __name__ == '__main__':
    ...
    logging.basicConfig(level=logging.DEBUG, filename='survey_backdeck_debug.log', format=log_fmt, filemode='w')
