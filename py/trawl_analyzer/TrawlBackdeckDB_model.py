from peewee import *
from py.trawl_analyzer.Settings import BackdeckModel as BaseModel

# database = SqliteDatabase('data\trawl_backdeck.db', **{})
...
class ImportProtocolsAgeweight(BaseModel):
    activation_date = TextField(db_column='ACTIVATION_DATE', null=True)
    deactivation_date = TextField(db_column='DEACTIVATION_DATE', null=True)
    investigator = TextField(db_column='INVESTIGATOR', null=True)
    item_name = TextField(db_column='ITEM_NAME', null=True)
    number_specimens = IntegerField(db_column='NUMBER_SPECIMENS', null=True)
    number_specimens_type = TextField(db_column='NUMBER_SPECIMENS_TYPE', null=True)
    nw_commonname = TextField(db_column='NW_COMMONNAME', null=True)
    nw_sciname = TextField(db_column='NW_SCINAME', null=True)
    observation_code = TextField(db_column='OBSERVATION_CODE', null=True)
    organization = TextField(db_column='ORGANIZATION', null=True)
    sampling_plan_name = TextField(db_column='SAMPLING_PLAN_NAME', null=True)
    storage_code = TextField(db_column='STORAGE_CODE', null=True)
    stratum_category_name = TextField(db_column='STRATUM_CATEGORY_NAME', null=True)
    stratum_maximum = IntegerField(db_column='STRATUM_MAXIMUM', null=True)
    stratum_minimum = IntegerField(db_column='STRATUM_MINIMUM', null=True)
    structurecode = TextField(db_column='STRUCTURECODE', null=True)
    survey = TextField(db_column='SURVEY', null=True)
    taxon = IntegerField(db_column='TAXON_ID', null=True)

    class Meta:
        db_table = 'Import_Protocols_AgeWeight'

class ImportProtocolsFinclips(BaseModel):
    activation_date = TextField(db_column='ACTIVATION_DATE', null=True)
    deactivation_date = TextField(db_column='DEACTIVATION_DATE', null=True)
    investigator = TextField(db_column='INVESTIGATOR', null=True)
    item_name = TextField(db_column='ITEM_NAME', null=True)
    ...
    organization = TextField(db_column='ORGANIZATION', null=True)
    sampling_plan_name = TextField(db_column='SAMPLING_PLAN_NAME', null=True)
    sampling_plan_stratum = TextField(db_column='SAMPLING_PLAN_STRATUM_ID', null=True)
    storage_code = TextField(db_column='STORAGE_CODE', null=True)
    stratum_category_name = TextField(db_column='STRATUM_CATEGORY_NAME', null=True)
    stratum_maximum = IntegerField(db_column='STRATUM_MAXIMUM', null=True)
    stratum_minimum = IntegerField(db_column='STRATUM_MINIMUM', null=True)
    stratum_name = TextField(db_column='STRATUM_NAME', null=True)
    structurecode = TextField(db_column='STRUCTURECODE', null=True)
    survey = TextField(db_column='SURVEY', null=True)
    taxon = IntegerField(db_column='TAXON_ID', null=True)

    class Meta:
        db_table = 'Import_Protocols_Finclips'

class ImportProtocolsOvaries(BaseModel):
    activation_date = TextField(db_column='ACTIVATION_DATE', null=True)
    deactivation_date = TextField(db_column='DEACTIVATION_DATE', null=True)
    investigator = TextField(db_column='INVESTIGATOR', null=True)
    item_name = TextField(db_column='ITEM_NAME', null=True)
    ...
    class Meta:
        db_table = 'Import_Protocols_Ovaries'

class ImportProtocolsSexlength(BaseModel):
    activation_date = TextField(db_column='ACTIVATION_DATE', null=True)
    deactivation_date = TextField(db_column='DEACTIVATION_DATE', null=True)
    investigator = TextField(db_column='INVESTIGATOR', null=True)
    item_name = TextField(db_column='ITEM_NAME', null=True)
    ...
    class Meta:
        db_table = 'Import_Protocols_SexLength'

class ImportProtocolsSpecialprojects(BaseModel):
    activation_date = TextField(db_column='ACTIVATION_DATE', null=True)
    deactivation_date = TextField(db_column='DEACTIVATION_DATE', null=True)
    investigator = TextField(db_column='INVESTIGATOR', null=True)
    item_name = TextField(db_column='ITEM_NAME', null=True)
    ...
    class Meta:
        db_table = 'Import_Protocols_SpecialProjects'

class ImportProtocolsStomachs(BaseModel):
    activation_date = TextField(db_column='ACTIVATION_DATE', null=True)
    deactivation_date = TextField(db_column='DEACTIVATION_DATE', null=True)
    investigator = TextField(db_column='INVESTIGATOR', null=True)
    item_name = TextField(db_column='ITEM_NAME', null=True)
    ...
    class Meta:
        db_table = 'Import_Protocols_Stomachs'

class ImportProtocolsTissues(BaseModel):
    activation_date = TextField(db_column='ACTIVATION_DATE', null=True)
    deactivation_date = TextField(db_column='DEACTIVATION_DATE', null=True)
    investigator = TextField(db_column='INVESTIGATOR', null=True)
    item_name = TextField(db_column='ITEM_NAME', null=True)
    ...
    class Meta:
        db_table = 'Import_Protocols_Tissues'
