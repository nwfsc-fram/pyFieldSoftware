...
Item {
    ...
    property bool multiplying_mode: false // For - and + key operation
    ...
    onMultnumpad: {
        ...
        } else if(multiplying_mode) {
            buttonKeyOK.multiplying_mode_ok();
        }
        setSkipButtonMode(false);
        multiplying_mode = true
        stored_result = textNumPad.text;
        buttonKeyOK.setText("=");
        setnumpadvalue(0);
    }
