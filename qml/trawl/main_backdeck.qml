...
ApplicationWindow {
    id: main
    title: qsTr("Field Collector - Trawl Survey Backdeck:")
    ...
    property string windowLabel: "Field Collector - Trawl Survey Backdeck:"
//    property TrawlBackdeckStateMachine tbdSM: tbdSM
...
//    property string obsFisheryType: ""
    ...
    TrawlBackdeckStateMachine {
        id: tbdSM
    }

//    TrawlBackdeckSettings {
//        id: tbdSettings
//    }

    function set_window_title(window_text) {
...
//        serialPortManager.stop_data_pusher_thread()
        close.accepted = true;
    }
...
//        icon: StandardIcon.Critical  // Does this get set?
