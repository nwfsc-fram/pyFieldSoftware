...
//        main.title = qsTr("ASHOP - Weight Baskets");
    }

    Component.onDestruction: {
        changeMode("takeWeight")

        // TODO Todd Hay - Not totally happy with this implementation, but good enough for now
        // I should have a signal for when the egMeasurementGroup is changed, and then use that to
        // drive changes to the weightType
...
//        console.info('newMode: ' + newMode + ', weightType: ' + weighBaskets.weightType)
