...
FramTabView {
    ...
    property var pageTally: null  // set when page onCompleted
    ...
    onEnableSpeciesTab: {
        console.debug(enable ? "SPECIES TAB Enabled" : "SPECIES TAB Disabled");
        tabSp.enabled = enable
    }

    signal enableCountWeightTab(bool enable)
    onEnableCountWeightTab: {
        console.debug(enable ? "CW TAB Enabled" : "CW TAB Disabled");
        tabCW.enabled = enable
    }
        ...
        if (catch_category_disposition === 'R') {
            ...
            if (discardReason) {
                ...
                console.debug("Disabled - " + (isSC ? "Species" : "Catch") +
                        " discard reason is null/undefined.");
                return false;
            }
        }
    }
    ...
    Component.onCompleted: {
        obsSM.state_change("cc_entry_fg_state");
    ...
    onCurrentIndexChanged: {
        ...
        case 0:
            ...
            break;
        case 1:
            obsSM.state_change("species_fg_entry_state");
            break;
        case 2:
            obsSM.state_change("tally_state");
            break;
        case 3:
