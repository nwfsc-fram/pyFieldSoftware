...
ApplicationWindow {
    id: main
    title: (stateMachine.screen === "sites") ?
        qsTr("CutterStation " + stateMachine.swVersion) :
        qsTr("CutterStation " + stateMachine.swVersion + " - Set ID: " + stateMachine.setId);
    width: 1920 // 1008 //1024     // 1040 with borders - 16 > 1008
    height: 1200 // 730 //768     // 806 with titlebar+borders - 38 > 730
    visible: true
    property alias screens: screens
    property alias dlgMessage: dlgMessage

    property string windowLabel: "Survey Backdeck:"
