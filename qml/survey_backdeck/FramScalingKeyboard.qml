...
Item {
    ...
    GridLayout {
        ...
        TextField {
            id: textKeyboard
            implicitWidth: parent.width * (12/13)
            ...
            style: ButtonStyle {
                ...
                label: Component {
                    Text {
                        ...
                        font.pixelSize: 25 * 0.75 // ScreenUnits.keyboardButtonTextHeight * 0.75
                        text: control.text
                    }
                }
            }
...
//        }
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges { target: buttonKeyQ; text: qsTr("q") }
            PropertyChanges { target: buttonKeyW; text: qsTr("w") }
            PropertyChanges { target: buttonKeyE; text: qsTr("e") }
