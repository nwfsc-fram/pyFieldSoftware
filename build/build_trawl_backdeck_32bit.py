...
#        path_platforms,
		...
		('../virtualenv/trawl_backdeck_32bit/opengl32sw.dll', 'opengl32sw.dll'),
        ('../resources/', 'resources'),
        ('../py/trawl', 'py/trawl'),
        ('../py/common', 'py/common'),
        ('../qml/trawl', 'qml/trawl'),
...
build_exe_options = {
                     ...
                     'packages':      packages, 
                     'path':          path,
                     'build_exe':     'build/exe.win32-3.6/trawl_backdeck'
}
...
deployed_path = r'build\exe.win32-3.6\trawl_backdeck'
...
# Zip up our creation
buildzipper.create_zip_archive(base_folder=deployed_path, filedesc='trawl_backdeck_32bit')
