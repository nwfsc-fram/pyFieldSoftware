...
# Zip up our creation
buildzipper.create_zip_archive(base_folder=deployed_path, filedesc='HookLogger', folders_to_zip=['HookLogger/HookLogger.exe', 'HookLogger/lib/library.zip', 'HookLogger/py', 'HookLogger/qml'])
